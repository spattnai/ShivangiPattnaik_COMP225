...
import static com.example.shoppinglist.Constants.AUTHORITY;
import static com.example.shoppinglist.Constants.CONTENT_URI;
...
public class ShoppingProvider extends ContentProvider {
   ...
   public boolean onCreate() {
      ...
      uriMatcher.addURI(AUTHORITY, "shoppinglist", ITEMS);
      uriMatcher.addURI(AUTHORITY, "shoppinglist/#", ITEMS_ID);
      shoppinglist = new ShoppingListData(getContext());
      return true;
   }
